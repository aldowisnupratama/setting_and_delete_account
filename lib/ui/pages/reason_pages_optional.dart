...
class ReasonPageOptional extends StatefulWidget {
  const ReasonPageOptional({Key? key}) : super(key: key);

  @override
  State<ReasonPageOptional> createState() => _ReasonPageOptionalState();
}

class _ReasonPageOptionalState extends State<ReasonPageOptional> {
  @override
                  ...
                  return Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          hintStyle: grey200TextStyle.copyWith(fontSize: 16)),
                    ),
                  );
                }
              }
